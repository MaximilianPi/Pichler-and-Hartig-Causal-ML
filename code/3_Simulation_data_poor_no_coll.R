...
saveRDS(results, "results/data_poor_small_MSE_no_coll.RDS")
...
saveRDS(results, "results/data_poor_mid_MSE_no_coll.RDS")
...
results = get_result(sim)
saveRDS(results, "results/data_poor_big_MSE_no_coll.RDS")
...
results = get_result(sim)
saveRDS(results, "results/data_poor_small_BIAS_no_coll.RDS")
...
results = get_result(sim)
saveRDS(results, "results/data_poor_mid_BIAS_no_coll.RDS")
...
results = get_result(sim)
saveRDS(results, "results/data_poor_big_BIAS_no_coll.RDS")
