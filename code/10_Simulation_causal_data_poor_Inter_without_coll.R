...
saveRDS(results, "results/data_poor_small_inter_without_coll.RDS")
...
results = get_result(sim)
saveRDS(results, "results/data_poor_mid_inter_without_coll.RDS")
...
results = get_result(sim)
saveRDS(results, "results/data_poor_big_inter_without_coll.RDS")
