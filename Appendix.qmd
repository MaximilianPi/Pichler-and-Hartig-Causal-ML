...
#| warning: false
#| message: false
small_10 = readRDS("results/NN_pars_100_10_SS.RDS")
small_100 = readRDS("results/NN_pars_100_100_SS.RDS")
large_10 = readRDS("results/NN_pars_1000_10_SS.RDS")
large_100 = readRDS("results/NN_pars_1000_100_SS.RDS")
...
#| fig-width: 8
#| fig-height: 2.5
small_10 =  readRDS("results/BRT_pars_100_10_SS.RDS")
small_100 = readRDS("results/BRT_pars_100_100_SS.RDS")
large_10 =  readRDS("results/BRT_pars_1000_10_SS.RDS")
large_100 = readRDS("results/BRT_pars_1000_100_SS.RDS")
results = list(small_10, small_100, large_10, large_100)
results = lapply(results, function(r) do.call(rbind, r))
results = lapply(results, function(r) r[abs(r$bias_1) < 0.98,])
results = lapply(results, function(r) r[abs(r$bias_5) < 0.98,])
...
#| fig-width: 8
#| fig-height: 2.5
small_10 =  readRDS("results/RF_pars_100_10_SS.RDS")
small_100 = readRDS("results/RF_pars_100_100_SS.RDS")
large_10 =  readRDS("results/RF_pars_1000_10_SS.RDS")
large_100 = readRDS("results/RF_pars_1000_100_SS.RDS")
results = list(small_10, small_100, large_10, large_100)
results = lapply(results, function(r) do.call(rbind, r))
results = lapply(results, function(r) r[abs(r$bias_1) < 0.98,])
results = lapply(results, function(r) r[abs(r$bias_5) < 0.98,])
...
#| fig-width: 8
#| fig-height: 2.5
small_10 =  readRDS("results/Elastic_net_pars_100_10_SS.RDS")
small_100 = readRDS("results/Elastic_net_pars_100_100_SS.RDS")
large_10 =  readRDS("results/Elastic_net_pars_1000_10_SS.RDS")
large_100 = readRDS("results/Elastic_net_pars_1000_100_SS.RDS")
results = list(small_10, small_100, large_10, large_100)
results = lapply(results, function(r) do.call(rbind, r))
results = lapply(results, function(r) r[abs(r$bias_1) < 0.98,])
results = lapply(results, function(r) r[abs(r$bias_5) < 0.98,])
