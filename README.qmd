...
This repository contains the code to reproduce the results in Inductive bias in black-box Machine Learning and Deep Learning models – consequences for the tradeoff between prediction and explanation under feature collinearity
